# Generated by Django 4.2.6 on 2023-12-11 12:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity_type', models.CharField(blank=True, choices=[('National Identity Card Number', 'National Identity Card Number'), ("Driver's License", "Driver's License"), ('Passport Number', 'Passport Number')], max_length=255, null=True)),
                ('id_image', models.FileField(blank=True, default='default.jpg', null=True, upload_to=UserAuth.models.user_directory_path)),
